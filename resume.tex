...
\geometry{left=2cm, top=1.2cm, right=2cm, bottom=1.8cm, footskip=.5cm}
...
\name{James}{Triantafylos}
%\position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\position{Computer Science Major}
%\address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

\mobile{(+1) 416-995-8689}
\email{jtriantafylos@gmail.com}
%\homepage{www.posquit0.com}
\github{JTriantafylos}
%\linkedin{posquit0}
% \gitlab{gitlab-id}
